package com.example.desafiodimensa.extensions
...
class FragmentViewBindingDelegate<VB : ViewBinding>(
    val fragment: Fragment, // referência ao seu fragment
    val viewBindingFactory: (View) -> VB // referência ao seu método de bind da classe ViewBinding
    ...
    init {
        fragment.lifecycle.addObserver(object : DefaultLifecycleObserver {
            ...
            // remove observer de lifecycle quando fragment é destruído
            override fun onDestroy(owner: LifecycleOwner) {

...
class GetTopRatedMoviesUseCaseTest {
    ...
    @Test
    fun `test invoke should return list of top rated movies`() = runBlocking {
        // Arrange
        val mockRepository = mockk<MovieRepository>()
        val useCase = GetTopRatedMoviesUseCase(mockRepository)
        ...
        coEvery { mockRepository.getTopRatedMovies(apiKey) } returns expectedMovies
